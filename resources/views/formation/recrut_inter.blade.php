...
{{-- start content --}}
@section('contenu')
<link rel="stylesheet" href="home/doublediplom.css">
<!-- Slider Area -->
{{-- <div class="container">
					...
					<div class="contour_presentation">
                        ...
                        <div class="titre">
							...
							<div class="explitexte">
                                Les écoles de ParisTech mutualisent depuis plus de 20 ans les programmes de recrutement d’étudiants à l’international dans leurs formations d’ingénieur en lien avec des partenaires académiques de premier plan dans leurs pays respectifs. Aujourd’hui trois zones géographiques sont identifiées comme prioritaires :
                            </div>
						</div>
                        <div class="titre">
                        ...
                        <div class="explitexte">
                            <p>
                                Les étudiants sélectionnés dans ce programme de recrutement obtiennent le diplôme d’ingénieur de l’école d’accueil de ParisTech et également, s’ils suivent un cursus de double diplôme,  le diplôme de Master ou d’ingénieur de leur université d’origine.
                            </p>

                            <p> 
                                Les cursus de formation proposés en France apportent une formation scientifique de haut niveau, des compétences multidisciplinaires, une ouverture sur l’économie, le management et la communication et permettent aux étudiants de bénéficier au travers de stages ou de projets des contacts étroits entre les écoles et les entreprises. Les étudiants acquièrent enfin au travers d’un séjour de longue durée l’expérience internationale indispensable aujourd’hui pour occuper des responsabilités importantes.
                            </p>
                            <p>
                                Ces programmes sont soutenus par les gouvernements au travers de programmes de bourses mais aussi par les industriels, pour qui le recrutement d’ingénieurs à haut potentiel est un enjeu important de leur stratégie de développement
                            </p>
                        </div>
                        <div class="titre">
