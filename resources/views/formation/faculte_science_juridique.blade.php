...
{{-- start content --}}
@section('contenu')
<link rel="stylesheet" href="{{asset('home/faculte_science_juridique.css')}}">
<!-- Slider Area -->
{{-- <div class="container">
		...
		<div class="col-10"> --}}
            ...
            <div class="container">
                <div class="section-title">
                    <h2><span> Facultés des Sciences Juridiques, Politiques et Sociales   </span> </h2>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="img_departement">
                            <img src="{{asset('images/ALU-advantage-web-new.png')}}" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-12">
