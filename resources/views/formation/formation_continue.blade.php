				...
				<div class="col-9">
					<div class="contour_presentation">
						...
						<div class="explitexte">
                            ...
                            <p> 
                                <strong> L’offre de mastères spécialisés® est particulièrement riche. Ces formations diplômantes, accréditées par la Conférence des grandes écoles, ont une vocation professionnalisante</strong>. Ces mastères sont construits en lien très étroit avec les entreprises et les organisations. Ouvrant sur une expertise ou une double compétence, ils s’adressent aussi bien à de jeunes diplômés en poursuite d’études qu’à des salariés en formation continue. Chaque mastère propose des modalités différentes : à temps plein et/ou à temps partiel. Développés au sein des départements ou des centres de recherche des écoles, ils bénéficient de l’expertise et du savoir-faire des enseignants-chercheurs des établissements.
                            </p>
                        </div>
						...
						<div class="titre">
							...
							<ul>
                                ...
                                <li> <a href="{{URL::to('/')}}"> Institut Supérieur de Batiment et de Travaux Publics - ISBTP </a> </li>
