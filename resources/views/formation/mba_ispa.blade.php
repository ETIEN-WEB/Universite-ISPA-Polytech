...
{{-- start content --}}
@section('contenu')
<link rel="stylesheet" href="{{asset('home/mba_ispa.css')}}">
<!-- Slider Area -->
{{-- <div class="container">
			...
			<div class="row">
				<div class="col-7">
					<div class="contour_presentation">
						...
						<div class="lestexte">
							Les Licences des écoles de l'Université Polytechnique ISPA:
						</div>
						<div class="titre">
						...
						<div class="titre">
							...
							<ul>
								...
								<li> <span> Cyber Sécurité et codage Informatique  </span></li>
								<li> <span> Industrielle Télécomunication  </span></li>
							</ul>
							<div class="">
