...
{{-- start content --}}
@section('contenu')
<link rel="stylesheet" href="{{asset('home/offre_formation.css')}}">
<!-- Slider Area -->
{{-- <div class="container">
		...
		<div class="col-10"> --}}
            ...
            <div class="container">
                <div class="section-title">
                    <h2><span>Offre de formation</span> </h2>
                </div>
                <div class="row">
			...
			<div class="row">
				<div class="col-9">
					<div class="contour_presentation">
						<div class="lestexte">
							Les écoles de ParisTech proposent une offre complète et unique de formations de réputation internationale allant du diplôme d’ingénieur (grade de master) au doctorat.
						</div>
                        ...
                        <div class="titre">
							...
							<div class="explitexte">
                                Couvrant l’ensemble du spectre des sciences, de la technologie et du management, ces programmes partagent de nombreuses caractéristiques d’excellence :
                            </div>
						</div>
                        <div class="titre">
							{{-- <p>   <strong> Partez à la découverte des écoles ParisTech :</strong> </p>	 --}}
							<ul>
								<li> des partenaires universitaires français et internationaux reconnus </li>
                                <li> des enseignants-chercheurs irriguant en permanence leurs enseignements des dernières avancées scientifiques </li>
                                <li> une forte proximité avec le tissu économique (laboratoires, entreprises, collectivités…)  </li>
                                <li> une démarche d’excellence validée par des accréditations nationales et internationales (CTI, CGE, HCERES, Equis, AMBA, AACSB…)  </li>
                                <li> l’adossement à des réseaux d’anciens élèves, acteurs de haut niveau du monde économique </li>
							</ul>
						</div>
