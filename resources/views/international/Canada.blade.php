			...
			<div class="row">
				<div class="col-9">
					<div class="contour_presentation">
						<div class="lestexte">
							ParisTech entretient des relations privilégiées avec des universités colombiennes prestigieuses et renforce ainsi sa dynamique de développement des relations internationales en Amérique latine.
						</div>
                        ...
                        <div class="titre">
							<p>   <strong> ParisTech souhaite ainsi </strong> </p>	
							<ul>
								<li> <span> 
                                    augmenter le nombre d’étudiants colombiens venant faire des études d’ingénieur en France,
                                </span> </li>
                                <li> <span> 
                                    encourager la mobilité des étudiants français vers la Colombie
                                </span> </li>
                                <li> <span> 
                                    renforcer la coopération scientifique et technologique
                                </span> </li>
							</ul>
						</div>
