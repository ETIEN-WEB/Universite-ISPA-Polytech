			...
			<div class="row">
				<div class="col-9">
					<div class="contour_presentation">
						<div class="lestexte">
							ParisTech a démarré en 2008 ses collaborations en Argentine. Ayant établi des partenariats solides avec quelques-unes des meilleures universités argentines depuis déjà des nombreux années, ParisTech renforce sa dynamique de développement des relations internationales en Amérique latine.
						</div>
                        ...
                        {{-- <div class="explitexte">
                            <p>
                                ParisTech participe à cette dynamique en renforçant les liens existants et en menant des actions coordonnées au nom de 
                            </p>
                            <p>
                        ...
                        <div class="titre">
							<a class="btn" href="images/CVetien1.pdf" target="_blank"> <i class="fa fa-eye"></i>  Voir les établissements partenaires </a>
						</div> --}}
                        ...
                        <div class="titre">
							...
							<ul>
								<li> <span> 
                                    Augmenter le nombre d’étudiants en double diplôme en signant des accords de double diplôme et en facilitant leur recrutement via le programme de recrutement international
                                </span> </li>
                                <li> <span> 
                                    Développer le réseau des alumni français et argentins (présentations, témoignages, site internet etc.)
                                </span> </li>
                                <li> <span> 
                                    Encourager les stages en entreprise ou dans les laboratoires au niveau master ou doctorat
                                </span> </li>
                                <li> <span> 
                                    Créer des liens entre enseignants-chercheurs dans les deux pays.
                                </span> </li>
							</ul>
						</div>
