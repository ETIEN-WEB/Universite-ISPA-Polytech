		...
		<div class="col-10"> --}}
            ...
            <div class="container">
                <div class="section-title">
                    <h2><span>La Communauté Ispa Polytech</span> </h2>
                </div>
                <div class="row">
			...
			<div class="row">
				<div class="col-9">
					<div class="contour_presentation">
						<div class="lestexte">
							Les écoles membres de ParisTech souhaitent développer une culture commune basée sur des valeurs distinctives et les attributs de la marque du réseau.
						</div>
                        ...
                        <div class="titre">
							...
							<div class="explitexte">
                                ParisTech Alumni  a pour vocation de fédérer l'ensemble des diplômés des écoles réunies au sein du réseau.
                                <br>
                                Soucieuses d’accompagner le développement de ParisTech, les associations d’anciens élèves ont décidé d’unir leurs efforts au sein de ParisTech Alumni. Ce réseau représente un total de près de 90 000 alumni.
                            </div>
						</div>
                        <div class="titre">
							<p>   <strong> La Fondation ParisTech </strong> </p>	
							<div class="explitexte">
                                Créée par décret en avril 2010, la Fondation ParisTech a pour but de contribuer au développement de l'enseignement supérieur et de la recherche scientifique et technologique, tant à l’échelon français qu’européen.
                                <br>
                                Fondation reconnue d’utilité publique, elle est née de l’initiative de ParisTech avec l’appui de grands groupes industriels, tous partenaires de l’enseignement supérieur et de la recherche.
                            </div>
						</div>
                        <div class="titre">
							<p>   <strong> La communauté des enseignants </strong> </p>	
							<div class="explitexte">
                                Soucieux de la qualité pédagogique des enseignements, les correspondants pédagogiques des écoles mettent en œuvre un programme d’accompagnement des enseignants pour un enrichissement de leurs pratiques pédagogiques au sein du programme RACINE.
                                <br>
