        ...
        <div class="container">
            <div class="contour_presentation">
				<div class="section-title">
                    <h2><span> Institut des Sciences Politiques et du Droit - ISPD</span> </h2>
                </div>
                <div class="row">
                        ...
                        <div class="ecole_carousel">
                            <div id="carouselExampleIndicators" class="carousel slide"  data-ride="carousel">
                                ...
                                <div class="carousel-item active">
                                    <img class="d-block w-100" src="{{asset('images/A_ecoles/ecole_cusel.jpg')}}" alt="First slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="{{asset('images/A_ecoles/ecole_cusel.jpg')}}" alt="Second slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="{{asset('images/A_ecoles/ecole_cusel.jpg')}}" alt="Third slide">
                                </div>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="row">
                            <div class="col-12">
                                <div class="logoecole">
                                    <img src="{{asset('images/A_logo/logo_ispd.png')}}">
