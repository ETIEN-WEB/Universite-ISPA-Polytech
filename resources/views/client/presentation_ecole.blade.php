...
{{-- start content --}}
@section('contenu')
<link rel="stylesheet" href="{{asset('home/presentation_ecole.css')}}">
<!-- Slider Area -->
{{-- <div class="container">
		...
		<div class="col-10"> --}}
            ...
            <div class="container">
                <div class="section-title">
                    <h2><span>Présentation des écoles de l'Université polytechnique ISPA</span> </h2>
                </div>
                <div class="row">
					...
					<div class="contour_presentation">
                        ...
                        <div class="titre">
							...
							<div class="explitexte">
                                La complémentarité des domaines d’excellence des écoles met à disposition des élèves, des chercheurs et de l’ensemble de nos partenaires (institutionnels et entreprises) un regroupement exceptionnel permettant une transdisciplinarité unique..
                            </div>
						</div>
                        <div class="titre">
